...
public class GetAppointmentFunction extends BaseRequestFunction implements RequestHandler<APIGatewayProxyRequestEvent,APIGatewayProxyResponseEvent> {
  ...
  public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
      ...
      if (appointment != null && appointment.getRegistrationKey().getUsername().equals(username)) {
        return new APIGatewayProxyResponseEvent()
          .withBody(serializeItem(appointment))
